    ...
    <>
      ...
      <section className="text-gray-400 bg-gray-900 body-font mx-auto pt-8">
        <div className="text-center w-3/5 mx-auto">
            <h1 className="sm:text-3xl text-2xl font-bold title-font text-white mb-4">A science based approach to betting using data points you would've never even thought about</h1>
            <p className="text-xl leading-relaxed font-medium text-gray-400 text-opacity-80">The average bettor researches between 3-8 data points when making decisions; our prediction model researches over 100 data points from each sports, down to the individual player level.</p>
          </div>
        <div className="container pb-5 py-24 mx-auto flex flex-wrap lg:w-4/5">
          <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
            <img alt="feature" className="object-cover object-center" src="https://props.cash/pick-min.png"/>
          </div>
          <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
            <div className="flex flex-col mb-10 lg:items-start items-center">
              <div className="flex-grow">
                <h2 className="text-white text-3xl title-font font-bold mb-3">Our Mission</h2>
                <p className="leading-relaxed text-lg font-semibold">To become the ultimate source of data to help bettors win more money</p>
              </div>
            </div>

            <div className="flex flex-col mb-10 lg:items-start items-center">
              <div className="flex-grow">
                <h2 className="text-white text-lg title-font font-semibold mb-3">Easy to use</h2>
                <p className="leading-relaxed text-base">Our models push out easy to read guides to tell you what is favored to win, based on our machine-learning models.</p>
                <p className="leading-relaxed text-base">Have a free bet, boost, or risk-free bet? Use our custom software to see how you can make the most out of that bet!</p>
              </div>
            </div>

            <div className="flex flex-col mb-10 lg:items-start items-center">
              <div className="flex-grow">
                <h2 className="text-white text-lg title-font font-semibold mb-3">Continuously improving</h2>
                <p className="leading-relaxed text-base">Our machine-learning prediction model uses data that dates back 5+ years in each sport. It also updates weekly from the most recent games played to get a better understanding of how games and players are performing NOW!</p>
              </div>
            </div>

            <div className="flex flex-col mb-10 lg:items-start items-center">
              <div className="flex-grow">
                <h2 className="text-white text-lg title-font font-semibold mb-3">Data on data on data</h2>
                <p className="leading-relaxed text-base">Like team and player props? Be sure to stay tuned to check out our prop bot, coming soon!</p>
              </div>
            </div>
            
            <div className="flex flex-col mb-10 lg:items-start items-center">
              <div className="flex-grow">
                <h2 className="text-white text-lg title-font font-semibold mb-3">The science</h2>
            ...
            <div className="flex flex-col mb-10 lg:items-start items-center">
              <div className="flex-grow">
                <h2 className="text-white text-lg title-font font-semibold mb-3">A family</h2>
