                                ...
                                cardContent.map( card => 
                                    <div class="card bg-gray-800 compact w-1/4 ">
                                        ...
                                        <div class="card-body space-y-2">
                                            ...
                                            <div className="flex flex-col font-semibold text-gray-900 pt-3">
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300 min-w-full">
                                                    ...
                                                    <div>Spread</div>
                                                    <div className="bg-green-200 text-gray-700 rounded-md p-1 ml-auto">{card.spread}</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300">
                                                    ...
                                                    <div>Winner</div>
                                                    <div className="bg-yellow-200 text-gray-700 rounded-md p-1 ml-auto">{card.moneyLine}</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300">
                                                    ...
                                                    <div>Over/Under</div>
                                                    <div className="bg-red-200 text-gray-700 rounded-md p-1 ml-auto">{card.total}</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300 ">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    ...
                                                    <div>Best Props</div>
                                                    <div className="bg-green-200 text-gray-700 rounded-md p-1 ml-auto">GB -7.5</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300 ">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
