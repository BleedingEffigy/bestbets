                        ...
                        <div className="flex flex-wrap space-x-1 justify-around">
                            {   
                                cardContent.map( card => 
                                    <div class="card bg-gray-800 compact w-1/4 relative mb-10">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {/* stats chart */}
                                            <div className="flex flex-col font-semibold text-gray-900 p-1 rounded-lg bg-gray-800 shadow-md z-10">
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300 min-w-full">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    </svg>
                                                    <div className="text-gray-400 font-medium">Spread</div>
                                                    <div className="border-green-500 border-2 text-green-700 rounded-md p-1 ml-auto">{card.spread}</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                                                    </svg>
                                                    <div className="text-gray-400 font-medium">Winner</div>
                                                    <div className="border-amber-300 border-2 text-amber-500 rounded-md p-1 ml-auto">{card.moneyLine}</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300">
                                                    ...
                                                    <div className="border-rose-400 border-2 text-rose-500 rounded-md p-1 ml-auto">{card.total}</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300 ">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    ...
                                                    <div className="border-green-500 border-2 text-green-700 rounded-md p-1 ml-auto">GB -7.5</div>
                                                </div>
                                                <div className="flex flex-row p-2 bg-gray-800 border-b-gray-700 border-b text-gray-300 ">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
