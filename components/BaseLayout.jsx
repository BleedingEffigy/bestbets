                        ...
                        <div class="container mx-auto flex flex-wrap py-1 flex-col md:flex-row items-center">
                            ...
                            <>
                                <a href="/api/auth/login">
                                    <button class="inline-flex items-center btn-sm btn-outline btn text-lime-500 hover:bg-lime-500 glass border-0 py-1 px-3 focus:outline-none hover:bg-lime-500 rounded text-base mt-4 md:mt-0">
                                    Log In
